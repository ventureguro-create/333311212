...
async def get_nearby_events(
    ...
    # Calculate bounding box (2x radius for edge cases)
    lat_delta = (radius_m * 2) / 111000
    lng_delta = (radius_m * 2) / (111000 * 0.65)  # cos(50°) ≈ 0.65
    ...
    try:
        ...
        }, {"_id": 0}).limit(limit * 3)  # Get more to filter by actual distance
