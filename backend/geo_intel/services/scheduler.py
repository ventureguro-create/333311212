...
from .notifier import send_telegram_alert, format_proximity_alert, format_multiple_events_alert
...
class GeoAlertScheduler:
    ...
    async def check_subscription(self, sub: dict) -> int:
        ...
        try:
            ...
            result = await send_telegram_alert(chat_id, text)
